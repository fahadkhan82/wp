    ...
    <div class="container">
      <div class="logos-component home__element">
        ...
        <div class="logos-component__logos-container">
          ...
          <div class="logos-component__img-container"> <a href="<?php echo get_site_url(); ?>/about-us/partner-networks/"> <img class="img-responsive logos-component__image" src="<?php echo get_site_url(null, '/wp-content/themes/sightspan'); ?>/assets/images/logo-hpe.jpg"/> </a> </div>
