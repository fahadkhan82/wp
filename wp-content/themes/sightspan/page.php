        ...
        <div class="col-md-3 stack-nav">
          <?php 
            ...
            if($i==1){
				...
				$link	=	get_site_url()."/workplace-mobility/";
			}elseif($i==8){
				$link	=	get_site_url()."/global-locations/";
			}
            ?>
...
<?php } elseif(get_the_id() == 86){?>
  ...
  <div class="wrapper">
    ...
    <div class="share_buttons">
	  ...
	  <div class="Youtube_Share"><a href="https://www.youtube.com/channel/UCqAOSdXbz93UpCwH_YIIPhw"><i class="fa fa-2x fa-youtube-square" aria-hidden="true"></i></a></div>
    </div>
    <br>
    <article>
